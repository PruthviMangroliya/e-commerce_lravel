...
//registration
Route::get('customer_register', [CustomerController::class, 'customer_register_form']);
...
//order
Route::get('frontend/customers_order', [CustomerController::class, 'customers_order'])->name('my_orders');
Route::get('frontend/order_details/{id}', [CustomerController::class, 'customers_order']);
Route::post('cancle_order/{id}', [CustomerController::class, 'cancle_order'])->name('cancle_order');
